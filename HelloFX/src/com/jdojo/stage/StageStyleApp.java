...
public class StageStyleApp extends Application {
    ...
    public void start(Stage stage) {
        ...
        // this.show(stage, styleLabel, DECORATED); // Incluye bordes y barra de titulo.
        //this.show(stage, styleLabel, UNDECORATED); // Muestra la ventana sin bordes y barra de titulo.
        this.show(stage, styleLabel, TRANSPARENT); // Fondo transparente.
        //this.show(stage, styleLabel, UNIFIED); // Muestra la ventana con un estilo unificado entre el contenido y la barra de título. 
        //this.show(stage, styleLabel, UTILITY); // Muestra la ventana con estilo "UTILITY": una ventana pequeña. 
    }
